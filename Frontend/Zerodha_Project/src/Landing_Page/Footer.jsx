    ...
    <footer style={{ backgroundColor: "rgb(250,250,250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          {/* Logo and copyright for all screen sizes */}
          <div className="col-12 col-md-6 col-lg-3 text-center text-lg-start mb-4">
            <img src={logo} alt="Logo" style={{ width: "50%" }} /><br />
...
//       <div className="row mt-5">
//         <div className="col">
//           <img src={logo} alt="" style={{ width: "50%" }} /><br/>
//           <p>© 2010 - 2024, Zerodha Broking Ltd.All rights reserved.</p>
//         </div>
//         <div className="col">
//           <p>Company</p>
